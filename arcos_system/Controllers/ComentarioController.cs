...
namespace arcos_system.Controllers
{
    public class ComentarioController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Comentarios")] Comentario comentario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Comentarios")] Comentario comentario)
        {
            if (id != comentario.Id)
            {
                return NotFound();
